...
<div class="<?php print $classes; ?> media-23video-auth-<?php print $id; ?>">
  <iframe width="<?php print $width; ?>" height="<?php print $height; ?>" title="<?php print $title; ?>" src="<?php print $url; ?>?login_token=<?php print $login_token; ?>" frameborder="0" allowfullscreen></iframe>
</div>
